...
public class Tela extends JFrame{
	...
	public Tela(String titulo) {
		...
		/*Na chamada ao construtor desse Gerenciador de Layout são informados
		//os números de linha (primeiro) e colunas (depois da vírgula)*/
		painel.add(lblNome);
		painel.add(txtNome);	
		painel.add(lblEmail);
		painel.add(txtEmail);
